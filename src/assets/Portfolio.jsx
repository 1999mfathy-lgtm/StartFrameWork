      ...
      <div className="container">
        <div className="row g-5">
          <div className="col-md-4  pic  ">
            ...
            <img src="src/assets/images/port1.png" alt="" className="img-fluid rounded-12" />
           ...
           <div className="col-md-4  pic  ">
             <div className="position-relative">
            <img src="src/assets/images/port2.png" alt="" className="img-fluid rounded-12" />
            <div className="layer rounded-12 d-flex justify-content-center align-items-center">
              <span className='plus text-white'><i className="fa-solid fa-plus"></i></span>
            </div>
             </div>
           ...
           <div className="col-md-4  pic  ">
             <div className="position-relative">
            <img src="src/assets/images/port3.png" alt="" className="img-fluid rounded-12" />
            <div className="layer rounded-12  d-flex justify-content-center align-items-center">
              <span className='plus text-white'><i className="fa-solid fa-plus"></i></span>
            </div>
             </div>
